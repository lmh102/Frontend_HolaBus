      ...
      <div className="col-md-12 d-flex justify-content-center">
        <div className="col-md-8 box-card bg-light">
          <form onSubmit={handleSubmit}>
            <div
              className="text-center text-light pt-3 pb-3 fs-4"
              style={{ backgroundColor: "#ff7921" }}
            >
              Book Route Bus
            </div>
            ...
            <div id="main-content">
              <Selection
                ...
                optionDefault="Select a location"
              ...
              <Selection
                ...
                name="busLocation"
                option={busNumber}
                optionDefault="Select a bus number"
              ...
              <ViewInfo
                label="Bus Scretary Phone"
                name="busScetaryPhone"
                value="Bus Route"
              />

              <ViewInfo
                label="List Location 1"
                name="ListLocation"
                value="Bus Route"
              />

              <ViewInfo
                label="List Location 2"
                name="busRoute"
                value="Bus Route"
              />
